...
actualData = np.genfromtxt("data_preprocessed_250_zScore3.csv", delimiter=',')[1:, :]
...
fullModelSimulatedData = np.genfromtxt("simulatedData/fullModel/fullModel.csv", delimiter=',')[1:, 1:]
