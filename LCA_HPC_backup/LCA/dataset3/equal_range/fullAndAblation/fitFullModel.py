...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 75), (0, 2), (0, 30), (0, 75), (0, 5), (-1, 1), (0, 75))                              # decay, competition, noiseStdDev, nonDecisionTime, threshold, constantInput1, lossWeight, startingBias, constantInput2
