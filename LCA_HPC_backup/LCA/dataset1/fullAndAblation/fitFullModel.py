...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 150), (0, 2), (0, 75), (0, 150), (0, 5), (-1, 1), (0, 150))                           # decay, competition, noiseStdDev, nonDecisionTime, threshold, constantInput1, lossWeight, startingBias, constantInput2
