...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 20), (0, 2), (0, 50), (0, 20), (-1, 1), (0, 20))
    # decay, competition, noiseStdDev, nonDecisionTime, threshold, constantInput1, startingBias, constantInput2
...
p.map(runMetropolis, range(5, 10))
