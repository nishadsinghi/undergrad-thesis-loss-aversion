...
def runMetropolis(chainIndex):
    ...
    # read observed data
    data = np.genfromtxt("data.csv", delimiter=',')[1:, 2:]
    ...
    bounds = ((0, 5), (0, 5), (0, 75), (0, 2), (0, 50), (-1, 1), (0, 75), (0, 75))   # decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = 'savedModels/noLossAversion'.format(str(bounds))
