...
# initialParameterVariance = (1, 1, 10, 0.25, 20, 20, 0.2)

# while True:
#     initialParameterValues = np.random.normal((0, 0, 0, 0, 0, 0, 0.5), initialParameterVariance)
#     if initialParameterValues[6] < 0:
#         initialParameterValues[6] = 0
#
#     if initialParameterValues[6] > 1:
#         initialParameterValues[6] = 1
#
...
try:
    saveFile = open('../data/varyAssumptions/variableProbabilityOfFocus.pickle', 'rb')
    ...
    parameterVariance = np.multiply(np.array((1, 1, 10, 0.25, 20, 20, 0.2)), parameterVarianceMultiplier)
except:
    exit()
...
for minimizationIteration in range(numIterationsPrevious, numIterationsMinAlgo+numIterationsPrevious):
    ...
    saveFile = open('../data/varyAssumptions/variableProbabilityOfFocus.pickle', 'wb')
