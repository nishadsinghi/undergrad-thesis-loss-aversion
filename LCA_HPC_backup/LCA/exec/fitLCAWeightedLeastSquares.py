...
SAVEFILENAME = '../data/weightedLeastSquare_bound=10_new.pickle'
        ...
        for gain in allGainValues:
            for loss in allLossValues:
                ...
                for choice in range(2):
                    ...
                    print("Num model responses: ", np.size(modelRTsForChoice))
...
bounds = ((0, 10), (0, 10), (0, 150), (0, 5), (0, 100), (0, 100), (0, 150))
...
initialParameterVariance = (4, 4, 40, 0, 20, 20, 40)
...
while True:
    ...
    initialParameterValues = generateProposalParams((5, 5, 75, 0.5, 50, 50, 75), initialParameterVariance)
...
for minimizationIteration in range(numIterationsMinAlgo):
    ...
    if minimizationIteration % 100 == 0 and minimizationIteration != 0:
        parameterVariance = (0.99, 0.99, 0.98, 0.99, 0.98, 0.98, 0.98) * parameterVariance
