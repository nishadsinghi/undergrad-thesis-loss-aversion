...
def runMetropolis(chainIndex):
        ...
        def __call__(self, parameters):
            ...
            for stakes in self.allStakes:
                ...
                for choice in range(2):
                    ...
                    expectedFrequencies = \
                    np.histogram(observedRTsForChoice, bins=np.concatenate(([0], quantilesBoundaries, [100])))[0] / numObservedTrials
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 1), (0, 5), (0, 1), (0, 50), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, attribute1Prob, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = '../../data/parallel/startingBias_dataset2_{}'.format(str(bounds))
