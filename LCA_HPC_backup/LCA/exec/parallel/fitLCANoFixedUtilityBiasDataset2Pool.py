...
def runMetropolis(chainIndex):
    ...
    lcaWrapper = lambda gain, loss, decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, attribute1Prob, constantInput: \
        lca((attribute1Prob, 1-attribute1Prob), getChoiceAttributes(gain, lossWeight*loss), getStartingActivation(startingBias, threshold), decay, competition, constantInput,
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 1), (0, 5), (0, 1), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, attribute1Prob, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = '../../data/parallel/noFixedUtilityBias_dataset2_{}_pool_noPrint'.format(str(bounds))
...
# with concurrent.futures.ProcessPoolExecutor(max_workers=numTotalChains) as executor:
#     executor.map(runMetropolis, range(numTotalChains))
