...
parser.add_argument("-i", "--chainIndex", required=True)
parser.add_argument("-n", "--numTotalChains", required=True)
args = parser.parse_args()

chainIndex = int(args.chainIndex)
numTotalChains = int(args.numTotalChains)
...
SAVE_DIRECTORY = '../../data/parallel/startingBias_dataset2_{}_bash'.format(str(bounds))
