...
def runMetropolis(chainIndex):
    ...
    lcaWrapper = lambda gain, loss, decay, competition, noiseStdDev, nonDecisionTime, threshold, lossWeight, constantInput1, constantInput2: \
        lca(attributeProbabilities, getChoiceAttributes(gain, lossWeight*loss), startingActivations, decay, competition, (constantInput1, constantInput2),
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (1, 7), (0, 50), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, lossWeight, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = '../../data/parallel/threeBiasOnly/noStartingBias_dataset2_{}'.format(str(bounds))
    ...
    while True:
        ...
        if pickleFlag or (minimizationIteration%100 == 0):
            pickleRecord(record)
