...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 0), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, constantInput
    ...
    SAVE_DIRECTORY = '../../data/parallel/threeBiasOnly/onlyStartingBias_dataset2_{}'.format(str(bounds))
