...
#
# while True:
#     initialParameterValues = np.random.normal(0, initialParameterVariance)                                              # didn't make any changes so I could compare it with the previous results
...
try:
    saveFile = open('../data/fitDifferentialLCA.pickle', 'rb')
...
for minimizationIteration in range(numIterationsMinAlgo):
    ...
    saveFile = open('../data/fitDifferentialLCA.pickle', 'wb')
