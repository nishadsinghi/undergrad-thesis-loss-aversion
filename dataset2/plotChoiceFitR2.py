...
data = np.genfromtxt("dataZeroSure.csv", delimiter=',')[1:, 2:]
...
fullModelData = np.genfromtxt("simulatedData/full/full.csv", delimiter=',')[1:, 2:]
print(fullModelData[:])
# plotData(ax, fullModelData, '--', 'Full Model')
plotR2(ax, fullModelData, data)
ax.set_title('Full Model')

ax = plt.subplot2grid(shape=(2,2), loc=(0,1), colspan=1)
# plotData(ax, data, '-', 'Experimental data')
noLossAversionData = np.genfromtxt("simulatedData/no_loss_aversion/no_loss_aversion.csv", delimiter=',')[1:, 2:]
...
# plotData(ax, data, '-', 'Experimental data')
noPredecisionalBiasData = np.genfromtxt("simulatedData/no_predecisional_bias/no_predecisional_bias.csv", delimiter=',')[1:, 2:]
...
# plotData(ax, data, '-', 'Experimental data')
noAlphaData = np.genfromtxt("simulatedData/no_alpha/no_alpha.csv", delimiter=',')[1:, 2:]
