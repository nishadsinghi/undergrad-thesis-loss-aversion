...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 75), (0, 2), (0, 50), (0, 7), (0, 75), (0, 75))  #decay, competition, noiseStdDev, nonDecisionTime, threshold, lossWeight, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = 'savedModels/noStartingBias'.format(str(bounds))
