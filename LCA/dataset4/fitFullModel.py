...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 75), (0, 2), (0, 50), (-1, 1), (0, 7), (0, 75), (0, 75))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, constantInput1, constantInput2
