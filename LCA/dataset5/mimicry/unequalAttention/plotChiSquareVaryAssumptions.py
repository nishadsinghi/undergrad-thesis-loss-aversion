...
params = [  1.27180266,   2.67391757, 138.72834956,   0.14891412,  44.58509749,  88.47867403,   1.85369553]
...
params = [ 7.66673498e-01,  2.49652705e+00,  7.92900846e+01,  4.84074530e-02, 3.84132541e+01,  5.27007244e+01, -2.40375420e-01]
modelSimulationData = generateModelData(lcaWrapper, params)
cost = computeCost(modelSimulationData)
print(cost)
...
params = [  2.74834435,   4.26364444, 105.92537393,   0.24960745,  32.56900491, 109.13742787,  93.22072122]
modelSimulationData = generateModelData(lcaWrapper, params)
cost = computeCost(modelSimulationData)
print(cost)
