...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 1), (0, 7), (0, 50), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, constantInput1, constantInput2
