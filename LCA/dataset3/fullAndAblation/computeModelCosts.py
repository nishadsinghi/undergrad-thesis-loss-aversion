...
fullModelData = np.genfromtxt("simulatedData/full.csv", delimiter=',')
fullModelChiSquared = computeChiSquared(fullModelData)
chiSquaredValues['full'] = fullModelChiSquared
fullModelAIC = computeAIC(fullModelData, 9)
AICValues['full'] = fullModelAIC

noLossAversionModelData = np.genfromtxt("simulatedData/noLossAversion.csv", delimiter=',')
noLossAversionChiSquared = computeChiSquared(noLossAversionModelData)
chiSquaredValues['noLossAversion'] = noLossAversionChiSquared
noLossAversionAIC = computeAIC(noLossAversionModelData, 8)
AICValues['noLossAversion'] = noLossAversionAIC
...
chiSquaredValues['noPredecisionalBias'] = noPredecisionalBiasChiSquared
noPredecisionalBiasAIC = computeAIC(noPredecisionalBiasData, 8)
AICValues['noPredecisionalBias'] = noPredecisionalBiasAIC


noFixedUtilityBiasData = np.genfromtxt("simulatedData/noFixedUtilityBias.csv", delimiter=',')
noFixedUtilityBiasChiSquared = computeChiSquared(noFixedUtilityBiasData)
chiSquaredValues['noFixedUtilityBias'] = noFixedUtilityBiasChiSquared
noFixedUtilityBiasAIC = computeAIC(noFixedUtilityBiasData, 8)
AICValues['noFixedUtilityBias'] = noFixedUtilityBiasAIC
