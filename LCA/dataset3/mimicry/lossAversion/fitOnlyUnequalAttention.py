...
def runMetropolis(chainIndex):
    ...
    # read observed data
    data = np.genfromtxt("lossAversionSimulatedData.csv", delimiter=',')
    ...
    bounds = ((0, 5), (0, 5), (0, 150), (0, 2), (0, 75), (0, 150), (0, 1))   # decay, competition, noiseStdDev, nonDecisionTime, threshold, constantInput, attribute1Prob
    ...
    SAVE_DIRECTORY = 'savedModels/onlyUnequalAttention'.format(str(bounds))
