...
def runMetropolis(chainIndex):
    ...
    # read observed data
    data = np.genfromtxt("startingBiasSimulatedData.csv", delimiter=',')
    ...
    lcaWrapper = lambda gain, loss, decay, competition, noiseStdDev, nonDecisionTime, threshold1, constantInput, threshold2: \
        lca((0.5, 0.5), getChoiceAttributes(gain, loss), (0, 0), decay, competition, constantInput,
    ...
    bounds = ((0, 5), (0, 5), (0, 150), (0, 2), (0, 75), (0, 150), (0, 75))   # decay, competition, noiseStdDev, nonDecisionTime, threshold1, constantInput, threshold2
    ...
    SAVE_DIRECTORY = 'savedModels/onlyUnequalThresholds'.format(str(bounds))
