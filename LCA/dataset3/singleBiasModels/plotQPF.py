...
lcaWrapper = lambda gain, loss, decay, competition, noiseStdDev, nonDecisionTime, threshold, constantInput1, lossWeight: lca(attributeProbabilities, getChoiceAttributes(gain, lossWeight * loss), getStartingActivation(0, threshold), decay, competition, constantInput1, noiseStdDev, nonDecisionTime, getAllThresholds(threshold))
...
plt.savefig("onlyLossAversionQPF.png", bbox_inches='tight')
plt.close()
