...
fullModelData = np.genfromtxt("simulatedData/5BiasFullModel.csv", delimiter=',')
fullModelChiSquared = computeChiSquared(fullModelData)
chiSquaredValues['full5BiasModel'] = fullModelChiSquared
fullModelAIC = computeAIC(fullModelData, 9)
AICValues['full5BiasModel'] = fullModelAIC
...
df.to_csv("simulatedData/5BiasModelCost.csv")