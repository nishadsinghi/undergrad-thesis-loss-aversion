...
np.savetxt("simulatedData/full.csv", modelSimulationData, delimiter=",")
...
modelSimulationData = generateModelData(lcaWrapper, params)
np.savetxt("simulatedData/noLossAversion.csv", modelSimulationData, delimiter=",")
# cost = computeCost(modelSimulationData)
# print(cost)
...
modelSimulationData = generateModelData(lcaWrapper, params)
np.savetxt("simulatedData/noPredecisionalBias.csv", modelSimulationData, delimiter=",")
# cost = computeCost(modelSimulationData)
# print(cost)
...
modelSimulationData = generateModelData(lcaWrapper, params)
np.savetxt("simulatedData/noFixedUtilityBias.csv", modelSimulationData, delimiter=",")
# cost = computeCost(modelSimulationData)
# print(cost)
