...
modelSimulationData = generateModelData(lcaWrapper, params)
np.savetxt("simulatedData/onlyUnequalAttention.csv", modelSimulationData, delimiter=",")
...
modelSimulationData = generateModelData(lcaWrapper, params)
np.savetxt("simulatedData/onlyUnequalThreshold.csv", modelSimulationData, delimiter=",")
