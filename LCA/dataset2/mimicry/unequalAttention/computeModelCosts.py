...
fullModelData = np.genfromtxt("simulatedData/unequalAttention_repeat.csv", delimiter=',')
fullModelChiSquared = computeChiSquared(fullModelData)
chiSquaredValues['unequalAttention (baseline)'] = fullModelChiSquared
fullModelAIC = computeAIC(fullModelData, 9)
AICValues['unequalAttention (baseline)'] = fullModelAIC
