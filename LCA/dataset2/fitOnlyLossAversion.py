...
def runMetropolis(chainIndex):
    ...
    # read observed data
    data = np.genfromtxt("dataZeroSure_cleaned_250_10500.csv", delimiter=',')[1:, 1:]
    ...
    lcaWrapper = lambda gain, loss, decay, competition, noiseStdDev, nonDecisionTime, threshold, lossWeight, constantInput: \
        lca(attributeProbabilities, getChoiceAttributes(gain, lossWeight*loss), getStartingActivation(0, threshold), decay, competition, constantInput,
    ...
    bounds = ((0, 5), (0, 5), (0, 75), (0, 2), (0, 30), (1, 7), (0, 75))   # decay, competition, noiseStdDev, nonDecisionTime, threshold, lossWeight, constantInput
    ...
    SAVE_DIRECTORY = 'savedModels/onlyLossAversion'.format(str(bounds))
