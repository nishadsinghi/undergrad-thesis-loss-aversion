...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (0, 5), (0, 1), (0, 50), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, attribute1Prob, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = '../../data/parallel/noStartingBias_dataset2_{}'.format(str(bounds))
