...
def runMetropolis(chainIndex):
    ...
    lcaWrapper = lambda gain, loss, decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, attribute1Prob, constantInput1, constantInput2: \
        lca((attribute1Prob, 1-attribute1Prob), getChoiceAttributes(gain, loss), getStartingActivation(startingBias, threshold), decay, competition, (constantInput1, constantInput2),
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 1), (0, 1), (0, 50), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, attribute1Prob, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = '../../data/parallel/noLossAversion_dataset2_{}'.format(str(bounds))
