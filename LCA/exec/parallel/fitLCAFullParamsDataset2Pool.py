...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 0), (1, 5), (0, 0.5), (0, 50), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, attribute1Prob, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = '../../data/parallel/dataset2_{}_tightBounds'.format(str(bounds))
