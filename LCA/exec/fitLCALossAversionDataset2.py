...
SAVEFILE = '../data/restrictedModels/lossAversionDataset2.pickle'
...
startTime = time.time()
print(costFunction([2.68790632,  1.00256435, 25.88580797,  0.12270113,  9.05514628, 24.59621147,  2.8273047]))
endTime = time.time()
...
bounds = ((0, 5), (0, 5), (0, 75), (0, 3), (0, 75), (0, 50), (0, 5))
