...
initialParameterVariance = (1, 1, 10, 0.25, 20, 20)
...
for minimizationIteration in range(numIterationsMinAlgo):
    ...
    if minimizationIteration % 100 == 0:
        parameterVariance = (1, 1, 0.99, 0.99, 0.99, 0.99) * parameterVariance
    ...
    saveFile = open('../data/varyAssumptions/noAssumptionRelaxed.pickle', 'wb')
