...
cost = computeCost(modelSimulationData)
print(cost)
labels.append("Unequal attention")
costs.append(cost)
...
cost = computeCost(modelSimulationData)
print(cost)
labels.append("Unequal thresholds")
costs.append(cost)
...
cost = computeCost(modelSimulationData)
print(cost)
labels.append("Unequal starting points")
costs.append(cost)
...
cost = computeCost(modelSimulationData)
print(cost)
labels.append("Unequal constant input")
costs.append(cost)
