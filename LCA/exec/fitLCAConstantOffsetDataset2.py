...
SAVEFILE = '../data/restrictedModels/constantOffsetDataset2.pickle'
...
costFunction = CostFunction(50, allStakes)

bounds = ((0, 5), (0, 5), (0, 75), (0, 3), (0, 75), (0, 50), (0, 1))    #gain, loss, decay, competition, noiseStdDev, nonDecisionTime, threshold, constantInput1, constantInput2:
...
parameterVarianceMultiplier = np.array((0.99, 0.99, 0.99, 0, 0.99, 0.99, 0.99))
