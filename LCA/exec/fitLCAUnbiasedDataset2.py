...
SAVEFILE = '../data/restrictedModels/unbiasedDataset2.pickle'
...
bounds = ((0, 5), (0, 5), (0, 75), (0, 3), (0, 75), (0, 50))    # decay, competition, noiseStdDev, nonDecisionTime, threshold, constantInput1, attribute1Prob
...
parameterVarianceMultiplier = np.array((0.99, 0.99, 0.99, 0, 0.99, 0.99))
