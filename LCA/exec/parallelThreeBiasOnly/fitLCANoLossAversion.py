...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 0), (0, 50), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, constantInput1, constantInput2
    ...
    SAVE_DIRECTORY = '../../data/parallel/threeBiasOnly/noLossAversion_dataset2_{}'.format(str(bounds))
