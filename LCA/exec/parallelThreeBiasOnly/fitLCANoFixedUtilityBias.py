...
def runMetropolis(chainIndex):
    ...
    bounds = ((0, 5), (0, 5), (0, 50), (0, 2), (0, 30), (-1, 0), (1, 7), (0, 50))   #decay, competition, noiseStdDev, nonDecisionTime, threshold, startingBias, lossWeight, constantInput
    ...
    SAVE_DIRECTORY = '../../data/parallel/threeBiasOnly/noFixedUtilityBias_dataset2_{}'.format(str(bounds))
