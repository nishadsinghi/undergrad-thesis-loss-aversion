...
def runMetropolis(chainIndex):
    ...
    # read observed data
    data = np.genfromtxt("../../../newDataset/dataZeroSure_RT_StdDevLessThan2.5_250_10500.csv", delimiter=',')[1:, 1:]
    print(data[:10, :])
    exit()
    ...
    SAVE_DIRECTORY = '../../data/parallel/threeBiasOnly/dataZeroSure_RT_StdDevLessThan2.5_250_10500_{}'.format(str(bounds))
