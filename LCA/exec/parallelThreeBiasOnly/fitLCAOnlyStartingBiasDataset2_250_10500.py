...
def runMetropolis(chainIndex):
    ...
    # read observed data
    data = np.genfromtxt("../../src/dataZeroSure_cleaned_250_10500.csv", delimiter=',')[1:, 1:]
    ...
    SAVE_DIRECTORY = '../../data/parallel/threeBiasOnly/onlyStartingBias_dataset2_250_10500_{}'.format(str(bounds))
