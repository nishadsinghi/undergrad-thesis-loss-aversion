...
actualData = np.genfromtxt("risk_data.csv", delimiter=',')[1:, :]
...
#
# plt.tight_layout()
# plt.savefig("fig/1_behavMarkerObservedOnly.png", bbox_inches='tight')
# plt.close()
#
# exit()
...
plt.tight_layout()
plt.savefig("fig/1_behavMarker.png", bbox_inches='tight')
plt.close()
